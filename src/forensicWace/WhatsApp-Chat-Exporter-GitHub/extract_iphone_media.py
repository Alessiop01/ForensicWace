...
def extract_media(base_dir, password):      # MODIFICATION: Added password parameter to call the command without user interaction
    if is_encrypted(base_dir):
        ...
        #password = getpass.getpass("Enter the password for the backup:")       # MODIFICATION: Removed user input password. Parameter must be passed in command call
